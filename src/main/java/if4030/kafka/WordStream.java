...
public final class WordStream {
    ...
    static Properties getStreamsConfig(final String[] args) throws IOException {
        ...
        props.putIfAbsent(StreamsConfig.APPLICATION_ID_CONFIG, "wordstream");
    ...
    static void createWordStream(final StreamsBuilder builder) {
        ...
        final KStream<String, String> wordStream = source
        ...
        wordStream.to(OUTPUT_TOPIC, Produced.with(Serdes.String(), Serdes.String()));
    }
